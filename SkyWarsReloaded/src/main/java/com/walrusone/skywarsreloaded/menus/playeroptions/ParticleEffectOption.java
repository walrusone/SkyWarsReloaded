...
public class ParticleEffectOption extends PlayerOption {
    ...
    public ParticleEffectOption(String key, List<ParticleEffect> effects, String name, Material material, int level, int cost, int position, int page, int menuSize) {
        this.key = key;
    	this.level = level;
    	this.cost = cost;
